var app = angular.module('vegan', ['ngRoute', 'ui.bootstrap', 'veganCtrl']);
...
// 缩放 sidebar
var ___toggerSidebar = true;
function toggerSidebar() {
  ___toggerSidebar = !___toggerSidebar;
  toggerRun();
}
function toggerRun() {
  if (___toggerSidebar) {
    $('#sidebar-wrapper').css('left', '-180px');
    $('#content-wrapper').css('padding-left', '85px');
  } else {
    $('#sidebar-wrapper').css('left', '0');
    $('#content-wrapper').css('padding-left', '265px');
  }
}
